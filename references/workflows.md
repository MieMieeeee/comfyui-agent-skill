...
`text_to_image` writes a positive prompt, optional dimensions, and a random seed into a registered T2I workflow. Negative prompt behavior remains in workflow config.
